...
export const MessageSection: FC = () => {
  return (
    <SectionContainer
      id="greeting"
      aria-label="대표변호사 인사말"
      className="relative isolate scroll-mt-24 overflow-hidden bg-[#070b11] text-brand-deep-foreground"
      innerClassName="grid gap-12 pt-28 pb-28 md:grid-cols-[minmax(0,18rem)_minmax(0,1fr)] md:items-end md:gap-10 md:pt-36 md:pb-36 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:max-w-[calc(71.25rem+4rem)] lg:gap-24 lg:pt-44 lg:pb-44"
      padded={false}
      background={
        <>
          <Image
