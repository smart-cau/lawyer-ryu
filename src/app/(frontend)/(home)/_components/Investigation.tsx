...
export const InvestigationSection: FC = () => {
  return (
    ...
    >
      <p className="text-overline text-muted-foreground">M-06 · 시급성</p>
      ...
      <p className="mx-auto mt-6 max-w-3xl text-body-lg text-muted-foreground">
        첫 조사 단계가 사건 전체 방향을 좌우합니다. 혼자 진술하지 말고, 사전 자문과 현장 동석으로 진술을 보호하세요.
      </p>

      <ul className="mx-auto mt-8 max-w-2xl space-y-3 text-body text-muted-foreground">
