...
export const InvestigationSection: FC = () => {
  return (
    <section
      ...
      className="relative left-1/2 isolate w-screen -translate-x-1/2 overflow-hidden bg-cover bg-center px-5 py-20 text-center text-white sm:px-8 sm:py-24 lg:px-12 lg:py-28"
      style={{
        backgroundImage:
          "linear-gradient(180deg, rgba(5, 9, 15, 0.28) 0%, rgba(5, 9, 15, 0.42) 46%, rgba(5, 9, 15, 0.62) 100%), url('/invesigation.png')",
      }}
    >
      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_34%,rgba(255,255,255,0.2),rgba(255,255,255,0)_30%)]"
      />
      <div
        aria-hidden
        className="absolute inset-x-0 bottom-0 -z-10 h-2/3 bg-gradient-to-t from-[#05090f]/65 via-[#05090f]/18 to-transparent"
      />
