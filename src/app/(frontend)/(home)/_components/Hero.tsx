...
// 핵심 경력은 사진 캡션으로 강조하되, 캡션이 숨는 md 미만에서는 bullet로 보존한다.
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-144 w-full max-w-7xl flex-col px-6 pt-32 pb-16 sm:px-8 md:min-h-176 md:justify-center md:pt-40 md:pb-24 lg:px-12 xl:px-16">
        ...
        {/* Cluster 2 — 변호사 신원·약력·CTA (이름 · credentials · 상담 버튼)
            모바일: about/lawyer처럼 이름을 사진 발치 fade 구간에 겹쳐 올린다 (구분선은 md 이상 전용) */}
        <div className="motion-entrance relative z-10 -mt-14 w-full max-w-160 [--motion-delay:300ms] md:mt-0 md:w-[52%]">
          <div className="mx-auto flex w-fit max-w-full items-baseline gap-2.5 md:mx-0 md:mt-6 md:border-t md:border-brand-gold/55 md:pt-4">
          ...
          <ul className="mt-5 space-y-2">
            <li className="flex items-start gap-2 text-body-1-reading text-white/85 [text-shadow:0_2px_16px_rgba(0,0,0,0.5)] md:hidden">
              <span
                aria-hidden
          ...
          <ul className="text-body-1 mt-6 w-fit border-t border-brand-gold/55 pt-4 text-left font-light text-white/90 [text-shadow:0_2px_16px_rgba(0,0,0,0.5)] md:text-headline-1 [&>li+li]:mt-4">
            <li>
              <a
                href={PHONE_HREF}
