...
export const PROPERTY_CRIME_SUBS: ServiceSubCategory[] = [
  {
    ...
    definition:
      '투자사기·유사수신 사건은 원금 보장, 확정 수익, 추천 수당 같은 설명을 믿고 돈을 보냈다가 투자 구조와 자금 흐름이 문제 되는 사건입니다.',
    commonSituations: [
  ...
  },
  {
    ...
    definition:
      '금융사기는 계좌, 대출, 보험금 청구, 투자·증권 거래 과정에서 금전 이동과 설명 내용이 형사 문제로 이어지는 사건입니다.',
    commonSituations: [
  ...
  },
  {
    ...
    definition:
      '가상화폐·리딩방 사기는 코인 거래, 유료 종목 추천, 자동매매, 수익 인증 자료를 둘러싸고 투자 손실과 기망 여부가 다투어지는 사건입니다.',
    commonSituations: [
  ...
  },
  {
    ...
    keywords: ['건축사기'],
    definition:
      '건축·분양 사기는 공사대금, 분양대금, 토지·허가·시공 가능성에 관한 설명이 계약 분쟁을 넘어 형사 문제로 번지는 사건입니다.',
    commonSituations: [
  ...
  },
  {
    ...
    definition:
      '횡령·배임·절도 사건은 맡아 둔 돈이나 물건, 공동사업 자금, 타인의 재산을 가져가거나 손해를 입혔는지가 문제 되는 재산범죄입니다.',
    commonSituations: [
