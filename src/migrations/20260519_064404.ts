...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "cases_populated_authors" (
  ...
  CREATE TABLE "_cases_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  ALTER TABLE "cases_populated_authors" ADD CONSTRAINT "cases_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."cases"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "cases_rels" ADD CONSTRAINT "cases_rels_cases_fk" FOREIGN KEY ("cases_id") REFERENCES "public"."cases"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_cases_v_version_populated_authors" ADD CONSTRAINT "_cases_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_cases_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_cases_v_rels" ADD CONSTRAINT "_cases_v_rels_cases_fk" FOREIGN KEY ("cases_id") REFERENCES "public"."cases"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "cases_populated_authors_order_idx" ON "cases_populated_authors" USING btree ("_order");
  CREATE INDEX "cases_populated_authors_parent_id_idx" ON "cases_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "cases_rels_cases_id_idx" ON "cases_rels" USING btree ("cases_id");
  ...
  CREATE INDEX "_cases_v_version_populated_authors_order_idx" ON "_cases_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX "_cases_v_version_populated_authors_parent_id_idx" ON "_cases_v_version_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "_cases_v_rels_cases_id_idx" ON "_cases_v_rels" USING btree ("cases_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "cases_populated_authors" CASCADE;
  DROP TABLE "cases" CASCADE;
  DROP TABLE "cases_rels" CASCADE;
  DROP TABLE "_cases_v_version_populated_authors" CASCADE;
