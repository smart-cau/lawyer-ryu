...
법무법인 인유 창원분사무소 대표변호사 **류남경** 홈페이지 기획을 위한 자료조사 디렉토리.

- 사무소: 경남 창원시 성산구 창이대로689번길 4-24, 5층 504호
- **상담문의 표시: 055-719-0302 / 010-7552-0301** — 두 번호를 용도 구분 없이 한 묶음으로 표시
- **전화 연결 번호: 055-719-0302** — 전화 버튼·상담 CTA·모든 `tel:` 링크에 적용 (사용자 결정 2026-07-15)
- 공식 블로그: https://blog.naver.com/inyou2025
- **운영 형태**: 류남경 대표변호사 *단독 운영* (어시스턴트·소속 변호사·수사관 출신 팀 부재)

## 디렉토리 구조

```
docs/
├── 00-compliance/     # 변호사법·변협 광고규정 등 컴플라이언스 가드레일
...
| 영역 | 파일 | 상태 |
|------|------|------|
| **변호사 광고규정 가드레일** | `00-compliance/lawyer-ad-regulations.md` | ✅ 20개 항목 표 + 핵심 4가지 적용 가이드 (마케팅 산출물 1순위 확인) |
...
| **배포 전 체크리스트** | `07-development/pre-deployment-checklist.md` | 🟡 배포 전 의사결정·완료 기준 관리 |
